...
\fancyhead[C]{\textit{Extract from Chapter 7 [Outlook] of the Bachelor's Thesis}} % Your text goes here
...
\begin{document}
    ...
    %\input{preamble/declaration}			% Erklärung
