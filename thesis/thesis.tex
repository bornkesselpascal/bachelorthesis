...
\begin{document}
    ...
    vom 11.01.2023 \\
   	...
   	\begin{itemize}
		\item Kapitel 2
		\begin{itemize}
  			\item \textit{neu:} Data Management Layer
  			\item \textit{neu:} Advanced Networking Options
		\end{itemize}

		\item Kapitel 3
		\begin{itemize}
  			\item \textit{überarbeitet:} Tabellen im Hardware Setup
  			\item \textit{neu:} Lastgenerierung mit stress-ng mit Vorstellung der Stressoren
		\end{itemize}
    ...
    \include{chapters/04_reliability}
	\include{chapters/05_performance}
