...
\begin{subtable}{\linewidth}
\centering
\begin{tabular}{C{2.2cm} C{4cm} C{4cm} C{4cm}}
	\toprule
	\textbf{Interface} & \textbf{X520-DA2} & \textbf{X540-T2} & \textbf{X710-T2L}\\
	\toprule
	\textbf{Year} & 2009 & 2012 & 2019\\
	\midrule
	\textbf{Ports} & Dual (SPF+) & Dual (RJ45) & Dual (RJ45)\\
	\midrule
	\textbf{System Interface} & PCIe v2.0 (5 GT/s), x8 Lane & PCIe v2.0 (5 GT/s), x8 Lane & PCIe v3.0 (8 GT/s), x8 Lane\\
	\midrule
	\textbf{Controller} & Intel 82599 & Intel X540 & Intel X710-AT2\\
	\midrule
	\textbf{Data Rate} & max. 10 GbE & max. 10 GbE & max. 10 GbE \\
	\bottomrule
\end{tabular}
\caption{Intel}
\end{subtable}
...
\begin{tabular}{C{2.2cm} C{4cm}}
	\toprule
	\textbf{Interface} & \textbf{X540-T2}\\
	\toprule
	\textbf{Year} & -\\
	\midrule
	\textbf{Ports} & Dual (RJ45)\\
	\midrule
	\textbf{System Interface} & PCIe v2.0 (5 GT/s), x8 Lane\\
	\midrule
	\textbf{Controller} & Intel X540\\
	\midrule
